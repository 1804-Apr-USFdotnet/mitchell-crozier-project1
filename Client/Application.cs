...
//    {
//        private readonly IRestaurantService __restaurantRepository;
...
//
//        public Application(IRestaurantService _restaurantRepository, IReviewService reviewService, ILoggingService loggingService, IInOut inOut)
//        {
...
//            var results = _restaurantRepository.TopThreeRatedRestaurants();
...
//                loggingService.Log(ex);
//            }
//            var results = _restaurantRepository.SearchByName(name);
//            inOut.Output(results);
//        }
//
...
//                loggingService.Log(ex);
//            }
//            var results = _restaurantRepository.AllReviewsForARestauraunt(name);
